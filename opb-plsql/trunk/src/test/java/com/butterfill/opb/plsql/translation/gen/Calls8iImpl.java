...
public class Calls8iImpl implements Calls8i {
    ...
    public String 
            ...
            throws OpbDataAccessException {
        final String methodName = "dataTypes(String, String, java.math.BigDecimal, Long, byte[], java.sql.Timestamp, java.sql.Blob, java.sql.Clob, Boolean, String[], java.math.BigDecimal[])";
