...
import com.butterfill.opb.timing.OpbTimingEvent;
 ...
 * cannot be changed.
 * <br/>
 * A timing event is started when an instance if this class is created and is
 * ended when callComplete() is called.
 * <br/>
...
public class OpbPlsqlCallHelper {
    ...
    /**
     * An event timer to be used by this class.
     */
    private OpbEventTimer eventTimer;
    
    /**
     * A timing event.
     */
    private OpbTimingEvent timingEvent;
     ...
     * 
     * @param eventTimer The event timer to be used by this helper.
     * @param connection The connection to be used by this helper.
     * @param sqlCall The SQL call that will be made by this helper.
     * @param eventName The event name to be used by this helper.
     * @throws com.butterfill.opb.data.OpbDataAccessException
     *   If we can't create a statement for the SQL call.
     */
    private void initHelper(final OpbEventTimer eventTimer, 
            final Connection connection, final String sqlCall, final String eventName) 
            throws OpbDataAccessException {
        final String methodName = 
                "initHelper(OpbEventTimer, Connection, String, String)";
        ...
        this.timingEvent = eventTimer.start(eventName);
    ...
    } // End of initHelper(OpbEventTimer ...
    
    
    /**
     * Creates a new instance of OpbPlsqlCallHelper.
     * This method starts a timing event and prepares the sql call.
     *
     * @param sourceLogger 
     ...
     * @param eventTimer 
     *   An event timer. Must not be null.
     * @param connection 
    ...
    public OpbPlsqlCallHelper(final Logger sourceLogger, final String sourceClass, 
            final String sourceMethod, final OpbEventTimer eventTimer,
            final Connection connection, final String sqlCall, final String eventName) 
            throws OpbDataAccessException {
        final String methodName = 
        ...
        initHelper(eventTimer, connection, sqlCall, eventName);
     ...
     *   An event timer provider. Must not be null.
     ...
     */
    public OpbPlsqlCallHelper(final Logger sourceLogger, final String sourceClass, 
            final String sourceMethod, final OpbEventTimerProvider eventTimerProvider,
            final OpbConnectionProvider connectionProvider, final String sqlCall, 
        ...
        OpbAssert.notNull(
                lggr, sourceClass, sourceMethod, 
                "EventTimerProvider", eventTimerProvider);

        OpbAssert.notNull(
                lggr, sourceClass, sourceMethod, 
                "ConnectionProvider", connectionProvider);
        
        OpbEventTimer timer = eventTimerProvider.getOpbEventTimer();
        ...
        initHelper(timer, conn, sqlCall, eventName);
     ...
     * <br/>
     * This method ends the timing event that was started when this object was
     * created.
     */
