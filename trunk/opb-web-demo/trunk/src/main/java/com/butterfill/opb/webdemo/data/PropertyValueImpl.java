...
public class PropertyValueImpl implements PropertyValue {
    ...
    public static final String CLASS_NAME =
            PropertyValueImpl.class.getName();
    ...
    public void opbLoad(final java.sql.ResultSet resultSet) 
        ...
        try {
            ...
            // load valueContainsCr from column value_contains_cr
            valueContainsCr = OpbSqlHelper.getValue(
                    valueContainsCr, resultSet, 
                    "value_contains_cr", true);
            ...
            // load key from column key
            key = OpbSqlHelper.getValue(
                    key, resultSet, 
                    "key", true);
            // save the value we just loaded as the datasource value
            keyDataSourceValue = key;
            
            // load propertyDescription from column property_description
            propertyDescription = OpbSqlHelper.getValue(
                    propertyDescription, resultSet, 
                    "property_description", true);
            // save the value we just loaded as the datasource value
            propertyDescriptionDataSourceValue = propertyDescription;
            
            // load sortOrder from column sort_order
            sortOrder = OpbSqlHelper.getValue(
                    sortOrder, resultSet, 
                    "sort_order", true);
            // save the value we just loaded as the datasource value
    ...
    public boolean getPropertyDescriptionChanged() {
        return !OpbComparisonHelper.isEqual(
                    propertyDescription, propertyDescriptionDataSourceValue);
    }
    ...
    public boolean getSortOrderChanged() {
        return !OpbComparisonHelper.isEqual(
                    sortOrder, sortOrderDataSourceValue);
    }
    ...
    public String 
            ...
            final String pOldKey,
            final String pOldPropertyDescription,
            final String pOldSortOrder,
        ...
        OpbPlsqlCallHelper opbCallHelper = new OpbPlsqlCallHelper(
                ...
                "BEGIN ? := property_value.del(?, ?, ?, ?, ?, ?); END;",
                "DbCall:property_value#del(VARCHAR2, VARCHAR2, VARCHAR2, VARCHAR2, VARCHAR2, VARCHAR2)");
        ...
        opbCallHelper.setObject(
                4, java.sql.Types.VARCHAR, pOldKey);
        
        opbCallHelper.setObject(
                5, java.sql.Types.VARCHAR, pOldPropertyDescription);
        
        opbCallHelper.setObject(
                6, java.sql.Types.VARCHAR, pOldSortOrder);
        
        opbCallHelper.setObject(
                7, java.sql.Types.VARCHAR, pOldValue);
    ...
    public String
        ...
        String result = del(
                ...
                getKeyDataSourceValue(),
                getPropertyDescriptionDataSourceValue(),
                getSortOrderDataSourceValue(),
                getValueDataSourceValue());
    ...
    public String 
        ...
        OpbPlsqlCallHelper opbCallHelper = new OpbPlsqlCallHelper(
                ...
                opbEventTimerProvider,
                opbConnectionProvider,
                "BEGIN ? := property_value.ins(?, ?, ?, ?, ?); END;",
                "DbCall:property_value#ins(VARCHAR2, VARCHAR2, VARCHAR2, VARCHAR2, VARCHAR2)");
        ...
        opbCallHelper.setObject(
                3, java.sql.Types.VARCHAR, pKey);
        
        opbCallHelper.setObject(
                4, java.sql.Types.VARCHAR, pPropertyDescription);
        
        opbCallHelper.setObject(
                5, java.sql.Types.VARCHAR, pSortOrder);
        
        opbCallHelper.setObject(
                6, java.sql.Types.VARCHAR, pValue);
    ...
    public String 
        ...
        OpbPlsqlCallHelper opbCallHelper = new OpbPlsqlCallHelper(
                ...
                opbEventTimerProvider,
                opbConnectionProvider,
                "BEGIN ? := property_value.upd(?, ?, ?, ?, ?, ?, ?, ?, ?, ?); END;",
                "DbCall:property_value#upd(VARCHAR2, VARCHAR2, VARCHAR2, VARCHAR2, VARCHAR2, VARCHAR2, VARCHAR2, VARCHAR2, VARCHAR2, VARCHAR2)");
        ...
        opbCallHelper.setObject(
                5, java.sql.Types.VARCHAR, pKey);
        
        opbCallHelper.setObject(
                6, java.sql.Types.VARCHAR, pOldPropertyDescription);
        
        opbCallHelper.setObject(
                7, java.sql.Types.VARCHAR, pPropertyDescription);
        
        opbCallHelper.setObject(
                8, java.sql.Types.VARCHAR, pOldSortOrder);
        
        opbCallHelper.setObject(
                9, java.sql.Types.VARCHAR, pSortOrder);
        
        opbCallHelper.setObject(
                10, java.sql.Types.VARCHAR, pOldValue);
        
        opbCallHelper.setObject(
                11, java.sql.Types.VARCHAR, pValue);
