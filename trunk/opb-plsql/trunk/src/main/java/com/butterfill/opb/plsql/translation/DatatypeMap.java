...
public final class DatatypeMap {
    ...
    /**
     * Initializes or re-initializes this DatatypeMap using the default datatype
     * map.
     * 
    ...
    public void initDatatypeMap(final InputStream inputStream) 
        ...
        try {
            ...
            OpbExceptionHelper.throwException(
                    ...
                    "Failed to initialize the DatatypeMap", ex),
                    logger,
                    CLASS_NAME,
                    methodName);
    ...
    private SqlJdbcJavaMap getSqlJdbcJavaMapBySql(final String s) {
        ...
        PlsqlSqlMap plsqlSqlMap = getPlsqlSqlMapByPlsql(s);
        if (plsqlSqlMap != null) {
            for (SqlJdbcJavaMap m : sqlJdbcJavaMappings) {
    ...
    public String sqlToJdbc(final String sqlType) {
        SqlJdbcJavaMap sqlJdbcJavaMap = getSqlJdbcJavaMapBySql(sqlType);
