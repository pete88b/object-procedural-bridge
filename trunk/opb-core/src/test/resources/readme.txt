******************************
readme for opb-core unit tests
******************************
...
use the default tablespace (which is probably SYSTEM).
...
To create the neccessary objects, run src/main/resources/sql/build.sql 
(from the opb-plsql project) via SQL*Plus using the connection details from 
