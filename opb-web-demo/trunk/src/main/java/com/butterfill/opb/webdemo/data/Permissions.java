...
public interface Permissions
     ...
     */
    java.util.List<Permission> getPermissions(String pPermissionSearchString,
            String pDescriptionSearchString,
            Long pStatusSearchValue) 
            throws OpbDataAccessException; 
     ...
     *   If we fail to make the database call.
     */
    java.util.List<Permission> getPermissionSets(String pPermissionSearchString,
            String pDescriptionSearchString,
            Long pStatusSearchValue) 
            throws OpbDataAccessException; 
